...
def render_guide(manager, characters):
    ...
    _section("An Eternal Page", (
        ...
        "on the page, like desktop buddies (Pom-Pom Gallery faces when near "
        "or feeling):\n\n"
        ...
        "Their faces follow how the talk and the sanctuary's hour actually feel — "
        "glad, weary, sharp — using the matching Pom-Pom Gallery pose.\n\n"
