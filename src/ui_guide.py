...
def render_guide(manager, characters):
    ...
    _section("Clicking the land", (
        "On **Visit** and **Walk the Land**, the **area picture is the stage**. "
        ...
        "Touch a figure on the picture (not a list of names). After you notice something, "
        "quiet touch glyphs appear under the art — pocket, sit, wave, drink, and the rest.\n\n"
