...
def render_guide(manager, characters):
    ...
    _section("The places to go", (
        ...
        "- **An Eternal Page** — Beyond Time. Official Q sitters stand on the "
        "star-swirl page (not Visit chatboxes). Click one, several, or all thirteen, "
    ...
    _section("An Eternal Page", (
        ...
        "This is **not** Visit an Heir. Companions sit as official Q figures "
        "on the page, like desktop buddies (Pom-Pom Gallery faces when you "
        "stand near or they answer):\n\n"
        "- **Click** to stand near (or step away)\n"
        "- **Double-click** to keep only that one\n"
        "- **Drag** to rearrange them on the parchment\n"
        "- **Right-click** for stand near / only them / a gentle touch "
        "(a touch warms mood; it never writes their words)\n"
        "- **All thirteen** / **Clear**, or the name row if a picture does not answer\n"
        "- Whisper in the dock — answers rise as speech bubbles, not a chat list\n\n"
        "Idle they stay the Q sitters. When you stand near or they answer, "
        "the matching Pom-Pom Gallery face comes forward. Mood still shows as "
        "marks on the page — glad, weary, sharp — from how the talk and the "
        "sanctuary's hour actually feel.\n\n"
        "They do not chase the cursor, walk the screen, or eat. There is no weather "
        "and no street life here. What you say is remembered in the same personal "
        "history as Visit, in Journey or Aftermath alike."
    ))
    ...
    _section("A gentle path to begin", (
        ...
        "4. Open **An Eternal Page** to stand with the Q sitters and whisper to one, several, or all.\n"
