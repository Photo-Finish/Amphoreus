...
- **Streamlit UI** (`src/ui_app.py`) — visit any Heir, see your bond with them, show them pictures, speak to them, read the Chronicle, and catch up on what they've lived through since your last visit.
